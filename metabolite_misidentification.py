...
def random_misidentification_heatmap():
    results_lists = []
        ...
        if d.startswith("Zamboni"):
            ...
            for i in [i for i in range(10, 70, 10)]:
                ...
                for x in misidentified_pathways:
                    ...
                    fraction_same_significant = number_common_paths/total_significant_paths
                    pathway_fractions.append(fraction_same_significant)
